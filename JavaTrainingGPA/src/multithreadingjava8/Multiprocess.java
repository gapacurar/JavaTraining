    ...
    public static void main(String[] args) {
        try {
            ...
            pb= new ProcessBuilder(
                    ...
                    "multithreadingjava8.SayHello",
                    "2", "John", "Jane");
            Map<String, String> env = pb.environment();
            env.put("TEXT_CONGRATS", "Softul lui cucu baw! ");
            env.remove("OTHERVAR");
            env.put("TEXT_HI", "Scris din programul Multiproicess.main");
            pb.directory(new File("C:\\Users\\gheor\\OneDrive\\Documents\\NetBeansProjects\\JavaTrainings\\JavaTrainingGPA\\build\\classes\\multithreadingjava8\\")
            );
            Process p1 = pb.start();
            Process p2 = pb.start();
